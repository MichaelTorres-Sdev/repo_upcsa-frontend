    ...
    <div className="test">
      ...
      <div className="introduction section">
        ...
        <p className="test_section-text">
          ...
          versiones y la colaboración. Te permite a ti y a otros trabajar juntos
          en proyectos desde cualquier lugar.
        </p>
        <p className="test_section-text">
        ...
        <ul className="test_section_ul">
          <li className="test_section_ul-item">Crear y usar un repositorio</li>
        ...
        <p className="test_section-text">
          ...
          comando o instalar Git (el software de control de versiones en el que
          se basa GitHub). Si tienes alguna pregunta sobre cualquiera de las
          expresiones utilizadas en esta guía, diríjase al{" "}
          <Link
            target="_blank"
            className="test_section-link"
            to={
      ...
      <div className="section creating">
        ...
        <hr />
        <p className="test_section-text">
          Un repositorio se suele utilizar para organizar un único proyecto. Los
          repositorios pueden contener carpetas y archivos, imágenes, videos,
          hojas de cálculo y conjuntos de datos, cualquier cosa que necesite su
          proyecto. A menudo, los repositorios incluyen un archivo README, un
          archivo con información sobre su proyecto. Los archivos README están
          escritos en el lenguaje Markdown de texto sin formato. GitHub le
          permite agregar un archivo README al mismo tiempo que crea su nuevo
          repositorio. GitHub también ofrece otras opciones comunes, como un
          archivo de licencia, pero no es necesario que seleccione ninguna de
          ellas ahora.
        </p>
      ...
      <div className="section branch">
        ...
        <hr />
        <p className="test_section-text">
          Las ramas te permiten tener multiple versiones de un repositorio a la
          vez;
        </p>
        <p className="test_section-text">
